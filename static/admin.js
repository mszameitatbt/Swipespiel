...
$("proposalQueue").innerHTML = pending.map(p=>    <div class="proposal-row">
...
$("constitutionRules").innerHTML=rules.map(r=>    <div class="constitution-rule">
...
$("actualRules").innerHTML=rules.map(r=>    <div class="actual-rule">
